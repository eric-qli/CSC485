...
bot sub [cat, sem, agr, cl_types, list].
    ...
    %     ...
    % === Your Code Here ===
    %agr intro [clf:classifier].
    %    classifier sub [sheep_cl, student_cl, wolf_cl].
...
xuesheng ---> (n, sem:(student, quantity:_), agr:clf:ming).
xuesheng ---> (n, sem:(student, quantity:_), agr:clf:ge).
lang ---> (n, sem:(wolf, quantity:_), agr:clf:zhi).
lang ---> (n, sem:(wolf, quantity:_), agr:clf:pi).
yang ---> (n, sem:(sheep, quantity:_), agr:clf:zhi).
ge ---> (cl, agr:clf:ge).
ming ---> (cl, agr:clf:ming).
zhi ---> (cl, agr:clf:zhi).
pi ---> (cl, agr:clf:pi).
